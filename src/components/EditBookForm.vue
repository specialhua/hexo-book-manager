  ...
  <div>
    ...
    >
      ...
      <n-form-item label="封面图片" path="cover">
        ...
        <!-- 封面预览 -->
        <div v-if="formValue.cover" class="cover-preview">
          <img :src="formValue.cover" alt="封面预览" />
        </div>
      </n-form-item>
...
const handleSave = async () => {
  ...
  try {
    ...
    const book: Book = {
      ...
      created_at: props.book.created_at, // 保持原有创建时间
      updated_at: new Date().toISOString(), // 更新修改时间
      sort_order: props.book.sort_order // 保持原有排序
    }
...
onMounted(() => {
  Object.assign(formValue, {
    ...
    douban_url: props.book.douban_url,
    description: props.book.description,
    download_link: props.book.download_link,
    extract_code: props.book.extract_code,
